...
Gem::Specification.new do |spec|
  ...
  spec.add_development_dependency("rubocop-capybara", "~> 2.17.0")
  spec.add_development_dependency("rubocop-factory_bot", "~> 2.22.0")
  ...
  spec.add_runtime_dependency("activeresource", "~> 6.2")
